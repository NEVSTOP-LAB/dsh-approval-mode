...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      ...
      "card.footnote": "全局默认值，立即生效并持久保存，对之后打开的会话生效；工具栏的「审批模式」按钮只改当前会话，不改这个默认值。",
    ...
    var en = {
      ...
      "card.footnote": "One global default, applied immediately and persisted, used by the sessions opened from now on; the composer toolbar's approval-mode button changes only the current session.",
